...
# #### `Math`
#
# 1)свой конспект сохранить в \Math\calculus\limit\название_последней_темы_дата.pdf, https://www.youtube.com/watch?v=zkTFyZVav-s&list=PLGtfmJuN1mTD2ND-zeBWHv3ACO5J0G9DR (Весь плейлист) (больше теории)
# 2)https://www.youtube.com/watch?v=ZAiDxlBCW28&list=PLCx14LDfH033RANLVFVAdFIxFHhy1VXHr ДО 6 видео(производная), (больше практики)
# 3)https://www.lektorium.tv/matematicheskij-analiz (прочитать весь "Список теоретических материалов"(под видео) и выписать в тетрадь все ПРИМЕРЫ И РЕШЕНИЯ), пройти до производных!
# конспект сохраняешь в \Math\calculus\lektorium\topic_name.pdf  topic_name - название темы
#
#
#
